...
class RBI::Node
  ...
  def satisfies_version?(*args, **, &blk); end
...
class RBI::NodeWithComments < RBI::Node
  ...
  def oneline?(*args, **, &blk); end
  def self.new(*args, **, &blk); end
  def version_requirements(*args, **, &blk); end
  extend T::Helpers
  extend T::Private::Abstract::Hooks
  extend T::Private::Methods::MethodHooks
  extend T::Private::Methods::SingletonMethodHooks
...
class RBI::Tree < RBI::NodeWithComments
  ...
  def filter_versions!(*args, **, &blk); end
...
class RBI::Method < RBI::NodeWithComments
  def <<(*args, **, &blk); end
  def accept_printer(*args, **, &blk); end
  def add_block_param(*args, **, &blk); end
  def add_kw_opt_param(*args, **, &blk); end
  def add_kw_param(*args, **, &blk); end
  def add_kw_rest_param(*args, **, &blk); end
  def add_opt_param(*args, **, &blk); end
  def add_param(*args, **, &blk); end
  def add_rest_param(*args, **, &blk); end
  def add_sig(*args, **, &blk); end
  def compatible_with?(*args, **, &blk); end
  def fully_qualified_name(*args, **, &blk); end
  def index_ids(*args, **, &blk); end
  def initialize(*args, **, &blk); end
...
class RBI::Parser::TreeBuilder < RBI::Parser::Visitor
  def collect_dangling_comments(*args, **, &blk); end
  def collect_orphan_comments(*args, **, &blk); end
  def current_scope(*args, **, &blk); end
  ...
  def visit_constant_assign(*args, **, &blk); end
