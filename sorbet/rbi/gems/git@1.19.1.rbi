...
class Git::Base
  ...
  #
  # source://git//lib/git/base.rb#112
  ...
  # @param options [Hash]
  #
  # source://git//lib/git/base.rb#276
  ...
  # source://git//lib/git/base.rb#508
  def apply(file); end

  # source://git//lib/git/base.rb#514
  def apply_mail(file); end

  # creates an archive file of the given tree-ish
  #
  # source://git//lib/git/base.rb#495
  def archive(treeish, file = T.unsafe(nil), opts = T.unsafe(nil)); end

  # source://git//lib/git/base.rb#613
  ...
  #  end
  #
  # source://git//lib/git/base.rb#134
  def chdir; end
  ...
  #
  # source://git//lib/git/base.rb#364
  def checkout_file(version, file); end

  # source://git//lib/git/base.rb#552
  ...
  #   :author
  #
  # source://git//lib/git/base.rb#346
  ...
  # g.config # returns whole config hash
  #
  # source://git//lib/git/base.rb#145
  ...
  # deletes a tag
  #
  # source://git//lib/git/base.rb#490
  ...
  #  :match
  #
  # source://git//lib/git/base.rb#324
  ...
  #  @git.dir.writeable?
  #
  # source://git//lib/git/base.rb#161
  def dir; end
  ...
  #
  # source://git//lib/git/base.rb#370
  def fetch(remote = T.unsafe(nil), opts = T.unsafe(nil)); end

  # source://git//lib/git/base.rb#504
  def gc; end
  ...
  # @return [Boolean]
  #
  # source://git//lib/git/base.rb#210
  ...
  # @return [Boolean]
  #
  # source://git//lib/git/base.rb#204
  ...
  #
  # source://git//lib/git/base.rb#218
  def lib; end

  # source://git//lib/git/base.rb#574
  def ls_files(location = T.unsafe(nil)); end

  # source://git//lib/git/base.rb#609
  ...
  # @overload push
  #
  # source://git//lib/git/base.rb#396
  def push(*args, **options); end

  # source://git//lib/git/base.rb#556
  def read_tree(treeish, opts = T.unsafe(nil)); end

  # returns an array of Git:Remote objects
  #
  # source://git//lib/git/base.rb#423
  def remotes; end

  # removes file(s) from the git repository
  #
  # source://git//lib/git/base.rb#281
  ...
  #
  # source://git//lib/git/base.rb#457
  def remove_remote(name); end

  # repacks the repository
  #
  # source://git//lib/git/base.rb#500
  def repack; end
  ...
  #
  # source://git//lib/git/base.rb#177
  def repo_size; end
  ...
  #   :no_edit
  #
  # source://git//lib/git/base.rb#334
  ...
  #
  # source://git//lib/git/base.rb#605
  ...
  # source://git//lib/git/base.rb#192
  ...
  #
  # source://git//lib/git/base.rb#523
  ...
  # source://git//lib/git/base.rb#569
  ...
  # source://git//lib/git/base.rb#537
  ...
  #
  # source://git//lib/git/base.rb#578
  ...
  class << self
    ...
    #
    # source://git//lib/git/base.rb#706
    ...
    #
    # source://git//lib/git/base.rb#634
    ...
    #
    # source://git//lib/git/base.rb#686
    ...
    #
    # source://git//lib/git/base.rb#653
...
module Git::Base::Factory
  ...
  #
  # source://git//lib/git/base/factory.rb#91
...
class Git::Branch < ::Git::Path
  ...
  # source://git//lib/git/branch.rb#29
  def archive(file, opts = T.unsafe(nil)); end

  # source://git//lib/git/branch.rb#24
  def checkout; end

  # @return [Boolean]
  #
  # source://git//lib/git/branch.rb#61
  def contains?(commit); end

  # source://git//lib/git/branch.rb#49
  def create; end

  # source://git//lib/git/branch.rb#57
  def current; end

  # source://git//lib/git/branch.rb#53
  def delete; end
  ...
  # source://git//lib/git/branch.rb#15
  def gcommit; end
  ...
  # end
  #
  # source://git//lib/git/branch.rb#38
  def in_branch(message = T.unsafe(nil)); end

  # source://git//lib/git/branch.rb#65
  ...
  # source://git//lib/git/branch.rb#20
  def stashes; end

  # source://git//lib/git/branch.rb#86
  def to_a; end

  # source://git//lib/git/branch.rb#90
  def to_s; end

  # source://git//lib/git/branch.rb#78
  def update_ref(commit); end

  private

  # source://git//lib/git/branch.rb#96
  def check_if_create; end

  # source://git//lib/git/branch.rb#100
  ...
  #
  # source://git//lib/git/branch.rb#135
  def parse_name(name); end
end

# source://git//lib/git/branch.rb#104
...
# @api public
#
# source://git//lib/git/failed_error.rb#14
class Git::FailedError < ::Git::GitExecuteError
  ...
  # @return [FailedError] a new instance of FailedError
  #
  # source://git//lib/git/failed_error.rb#29
  ...
  #
  # source://git//lib/git/failed_error.rb#51
  def result; end
end
...
# This error is raised when a git command fails
#
# source://git//lib/git/git_execute_error.rb#6
...
class Git::Lib
  ...
  # @param options [Hash]
  #
  # source://git//lib/git/lib.rb#653
  def add(paths = T.unsafe(nil), options = T.unsafe(nil)); end

  # source://git//lib/git/lib.rb#748
  def apply(patch_file); end

  # source://git//lib/git/lib.rb#754
  ...
  #  :path
  #
  # source://git//lib/git/lib.rb#1061
  ...
  #
  # source://git//lib/git/lib.rb#240
  def commit_data(sha); end

  # source://git//lib/git/lib.rb#1027
  ...
  #
  # source://git//lib/git/lib.rb#1113
  def compare_version_to(*other_version); end

  # source://git//lib/git/lib.rb#585
  def config_get(name); end

  # source://git//lib/git/lib.rb#593
  def config_list; end

  # source://git//lib/git/lib.rb#575
  def config_remote(name); end

  # WRITE COMMANDS ##
  #
  # source://git//lib/git/lib.rb#629
  ...
  #
  # source://git//lib/git/lib.rb#1094
  ...
  #
  # source://git//lib/git/lib.rb#170
  def describe(committish = T.unsafe(nil), opts = T.unsafe(nil)); end

  # compares the index and the working directory
  #
  # source://git//lib/git/lib.rb#530
  def diff_files; end

  # source://git//lib/git/lib.rb#486
  ...
  # source://git//lib/git/lib.rb#267
  def each_cat_file_header(data); end

  # source://git//lib/git/lib.rb#937
  def fetch(remote, opts); end

  # source://git//lib/git/lib.rb#203
  def full_log_commits(opts = T.unsafe(nil)); end

  # source://git//lib/git/lib.rb#359
  def full_tree(sha); end

  # source://git//lib/git/lib.rb#1011
  def gc; end
  ...
  # source://git//lib/git/lib.rb#589
  def global_config_get(name); end

  # source://git//lib/git/lib.rb#597
  def global_config_list; end

  # source://git//lib/git/lib.rb#637
  ...
  # [tree-ish] = [[line_no, match], [line_no, match2]]
  #
  # source://git//lib/git/lib.rb#463
  def grep(string, opts = T.unsafe(nil)); end

  # source://git//lib/git/lib.rb#570
  ...
  # @return [String] the object information
  #
  # source://git//lib/git/lib.rb#619
  def show(objectish = T.unsafe(nil), path = T.unsafe(nil)); end

  # source://git//lib/git/lib.rb#779
  def stash_apply(id = T.unsafe(nil)); end

  # source://git//lib/git/lib.rb#787
  def stash_clear; end

  # source://git//lib/git/lib.rb#791
  def stash_list; end

  # source://git//lib/git/lib.rb#774
  def stash_save(message); end

  # source://git//lib/git/lib.rb#760
  def stashes_all; end

  # source://git//lib/git/lib.rb#912
  def tag(name, *opts); end

  # source://git//lib/git/lib.rb#280
  def tag_data(name); end

  # source://git//lib/git/lib.rb#1000
  def tag_sha(tag_name); end

  # source://git//lib/git/lib.rb#908
  def tags; end

  # source://git//lib/git/lib.rb#363
  def tree_depth(sha); end

  # source://git//lib/git/lib.rb#858
  def unmerged; end

  # source://git//lib/git/lib.rb#1040
  def update_ref(ref, commit); end

  # source://git//lib/git/lib.rb#429
  def worktree_add(dir, commitish = T.unsafe(nil)); end

  # source://git//lib/git/lib.rb#438
  def worktree_prune; end

  # source://git//lib/git/lib.rb#434
  def worktree_remove(dir); end

  # source://git//lib/git/lib.rb#409
  def worktrees_all; end

  # source://git//lib/git/lib.rb#1023
  def write_tree; end
  ...
  # source://git//lib/git/lib.rb#1141
  ...
  #
  # source://git//lib/git/lib.rb#1260
  ...
  #
  # source://git//lib/git/lib.rb#1284
  ...
  #
  # source://git//lib/git/lib.rb#1167
  def set_custom_git_env_variables; end

  # Takes the current git's system ENV variables and store them.
  #
  # source://git//lib/git/lib.rb#1152
  ...
  #
  # source://git//lib/git/lib.rb#1178
...
# source://git//lib/git/lib.rb#371
Git::Lib::BRANCH_LINE_REGEXP = T.let(T.unsafe(nil), Regexp)

# source://git//lib/git/lib.rb#265
...
#
# source://git//lib/git/lib.rb#1139
...
class Git::Log
  ...
  # source://git//lib/git/log.rb#13
  def all; end

  # source://git//lib/git/log.rb#25
  ...
  # source://git//lib/git/log.rb#19
  def object(objectish); end

  # source://git//lib/git/log.rb#37
  def path(path); end

  # source://git//lib/git/log.rb#49
  def since(date); end

  # forces git log to run
  #
  # source://git//lib/git/log.rb#80
  def size; end

  # source://git//lib/git/log.rb#43
  def skip(num); end

  # source://git//lib/git/log.rb#73
  def to_s; end

  # source://git//lib/git/log.rb#55
  def until(date); end
  ...
  # source://git//lib/git/log.rb#108
  def dirty_log; end

  # actually run the 'git log' command
  #
  # source://git//lib/git/log.rb#120
  def run_log; end
end
...
class Git::Remote < ::Git::Path
  ...
  # source://git//lib/git/remote.rb#24
  ...
  # source://git//lib/git/remote.rb#29
  def remove; end

  # source://git//lib/git/remote.rb#33
  def to_s; end
...
# @api public
#
# source://git//lib/git/signaled_error.rb#14
class Git::SignaledError < ::Git::GitExecuteError
  ...
  # @return [SignaledError] a new instance of SignaledError
  #
  # source://git//lib/git/signaled_error.rb#26
  def initialize(result); end
  ...
  # @return [Git::CommandLineResult]
  #
  # source://git//lib/git/signaled_error.rb#48
  def result; end
end
...
class Git::Status
  ...
  # source://git//lib/git/status.rb#191
  def fetch_added; end

  # source://git//lib/git/status.rb#184
