...
module Spoom::Deadcode
  ...
  def self.index_node(*args, **, &blk); end
  def self.index_ruby(*args, **, &blk); end
  def self.load_custom_plugins(*args, **, &blk); end
  def self.parse_ruby(*args, **, &blk); end
  def self.plugins_from_gemfile_lock(*args, **, &blk); end
end
class Spoom::Deadcode::Visitor < Prism::Visitor
  def visit_alias_global_variable_node(*args, **, &blk); end
  def visit_alias_method_node(*args, **, &blk); end
  def visit_alternation_pattern_node(*args, **, &blk); end
  def visit_and_node(*args, **, &blk); end
  def visit_arguments_node(*args, **, &blk); end
  def visit_array_node(*args, **, &blk); end
  def visit_array_pattern_node(*args, **, &blk); end
  def visit_assoc_node(*args, **, &blk); end
  def visit_assoc_splat_node(*args, **, &blk); end
  def visit_back_reference_read_node(*args, **, &blk); end
  def visit_begin_node(*args, **, &blk); end
  def visit_block_argument_node(*args, **, &blk); end
  def visit_block_local_variable_node(*args, **, &blk); end
  def visit_block_node(*args, **, &blk); end
  def visit_block_parameter_node(*args, **, &blk); end
  def visit_block_parameters_node(*args, **, &blk); end
  def visit_break_node(*args, **, &blk); end
  def visit_call_and_write_node(*args, **, &blk); end
  def visit_call_node(*args, **, &blk); end
  def visit_call_operator_write_node(*args, **, &blk); end
  def visit_call_or_write_node(*args, **, &blk); end
  def visit_call_target_node(*args, **, &blk); end
  def visit_capture_pattern_node(*args, **, &blk); end
  def visit_case_match_node(*args, **, &blk); end
  def visit_case_node(*args, **, &blk); end
  def visit_child_nodes(*args, **, &blk); end
  def visit_class_node(*args, **, &blk); end
  def visit_class_variable_and_write_node(*args, **, &blk); end
  def visit_class_variable_operator_write_node(*args, **, &blk); end
  def visit_class_variable_or_write_node(*args, **, &blk); end
  def visit_class_variable_read_node(*args, **, &blk); end
  def visit_class_variable_target_node(*args, **, &blk); end
  def visit_class_variable_write_node(*args, **, &blk); end
  def visit_constant_and_write_node(*args, **, &blk); end
  def visit_constant_operator_write_node(*args, **, &blk); end
  def visit_constant_or_write_node(*args, **, &blk); end
  def visit_constant_path_and_write_node(*args, **, &blk); end
  def visit_constant_path_node(*args, **, &blk); end
  def visit_constant_path_operator_write_node(*args, **, &blk); end
  def visit_constant_path_or_write_node(*args, **, &blk); end
  def visit_constant_path_target_node(*args, **, &blk); end
  def visit_constant_path_write_node(*args, **, &blk); end
  def visit_constant_read_node(*args, **, &blk); end
  def visit_constant_target_node(*args, **, &blk); end
  def visit_constant_write_node(*args, **, &blk); end
  def visit_def_node(*args, **, &blk); end
  def visit_defined_node(*args, **, &blk); end
  def visit_else_node(*args, **, &blk); end
  def visit_embedded_statements_node(*args, **, &blk); end
  def visit_embedded_variable_node(*args, **, &blk); end
  def visit_ensure_node(*args, **, &blk); end
  def visit_false_node(*args, **, &blk); end
  def visit_find_pattern_node(*args, **, &blk); end
  def visit_flip_flop_node(*args, **, &blk); end
  def visit_float_node(*args, **, &blk); end
  def visit_for_node(*args, **, &blk); end
  def visit_forwarding_arguments_node(*args, **, &blk); end
  def visit_forwarding_parameter_node(*args, **, &blk); end
  def visit_forwarding_super_node(*args, **, &blk); end
  def visit_global_variable_and_write_node(*args, **, &blk); end
  def visit_global_variable_operator_write_node(*args, **, &blk); end
  def visit_global_variable_or_write_node(*args, **, &blk); end
  def visit_global_variable_read_node(*args, **, &blk); end
  def visit_global_variable_target_node(*args, **, &blk); end
  def visit_global_variable_write_node(*args, **, &blk); end
  def visit_hash_node(*args, **, &blk); end
  def visit_hash_pattern_node(*args, **, &blk); end
  def visit_if_node(*args, **, &blk); end
  def visit_imaginary_node(*args, **, &blk); end
  def visit_implicit_node(*args, **, &blk); end
  def visit_implicit_rest_node(*args, **, &blk); end
  def visit_in_node(*args, **, &blk); end
  def visit_index_and_write_node(*args, **, &blk); end
  def visit_index_operator_write_node(*args, **, &blk); end
  def visit_index_or_write_node(*args, **, &blk); end
  def visit_index_target_node(*args, **, &blk); end
  def visit_instance_variable_and_write_node(*args, **, &blk); end
  def visit_instance_variable_operator_write_node(*args, **, &blk); end
  def visit_instance_variable_or_write_node(*args, **, &blk); end
  def visit_instance_variable_read_node(*args, **, &blk); end
  def visit_instance_variable_target_node(*args, **, &blk); end
  def visit_instance_variable_write_node(*args, **, &blk); end
  def visit_integer_node(*args, **, &blk); end
  def visit_interpolated_match_last_line_node(*args, **, &blk); end
  def visit_interpolated_regular_expression_node(*args, **, &blk); end
  def visit_interpolated_string_node(*args, **, &blk); end
  def visit_interpolated_symbol_node(*args, **, &blk); end
  def visit_interpolated_x_string_node(*args, **, &blk); end
  def visit_keyword_hash_node(*args, **, &blk); end
  def visit_keyword_rest_parameter_node(*args, **, &blk); end
  def visit_lambda_node(*args, **, &blk); end
  def visit_local_variable_and_write_node(*args, **, &blk); end
  def visit_local_variable_operator_write_node(*args, **, &blk); end
  def visit_local_variable_or_write_node(*args, **, &blk); end
  def visit_local_variable_read_node(*args, **, &blk); end
  def visit_local_variable_target_node(*args, **, &blk); end
  def visit_local_variable_write_node(*args, **, &blk); end
  def visit_match_last_line_node(*args, **, &blk); end
  def visit_match_predicate_node(*args, **, &blk); end
  def visit_match_required_node(*args, **, &blk); end
  def visit_match_write_node(*args, **, &blk); end
  def visit_missing_node(*args, **, &blk); end
  def visit_module_node(*args, **, &blk); end
  def visit_multi_target_node(*args, **, &blk); end
  def visit_multi_write_node(*args, **, &blk); end
  def visit_next_node(*args, **, &blk); end
  def visit_nil_node(*args, **, &blk); end
  def visit_no_keywords_parameter_node(*args, **, &blk); end
  def visit_numbered_parameters_node(*args, **, &blk); end
  def visit_numbered_reference_read_node(*args, **, &blk); end
  def visit_optional_keyword_parameter_node(*args, **, &blk); end
  def visit_optional_parameter_node(*args, **, &blk); end
  def visit_or_node(*args, **, &blk); end
  def visit_parameters_node(*args, **, &blk); end
  def visit_parentheses_node(*args, **, &blk); end
  def visit_pinned_expression_node(*args, **, &blk); end
  def visit_pinned_variable_node(*args, **, &blk); end
  def visit_post_execution_node(*args, **, &blk); end
  def visit_pre_execution_node(*args, **, &blk); end
  def visit_program_node(*args, **, &blk); end
  def visit_range_node(*args, **, &blk); end
  def visit_rational_node(*args, **, &blk); end
  def visit_redo_node(*args, **, &blk); end
  def visit_regular_expression_node(*args, **, &blk); end
  def visit_required_keyword_parameter_node(*args, **, &blk); end
  def visit_required_parameter_node(*args, **, &blk); end
  def visit_rescue_modifier_node(*args, **, &blk); end
  def visit_rescue_node(*args, **, &blk); end
  def visit_rest_parameter_node(*args, **, &blk); end
  def visit_retry_node(*args, **, &blk); end
  def visit_return_node(*args, **, &blk); end
  def visit_self_node(*args, **, &blk); end
  def visit_singleton_class_node(*args, **, &blk); end
  def visit_source_encoding_node(*args, **, &blk); end
  def visit_source_file_node(*args, **, &blk); end
  def visit_source_line_node(*args, **, &blk); end
  def visit_splat_node(*args, **, &blk); end
  def visit_statements_node(*args, **, &blk); end
  def visit_string_node(*args, **, &blk); end
  def visit_super_node(*args, **, &blk); end
  def visit_symbol_node(*args, **, &blk); end
  def visit_true_node(*args, **, &blk); end
  def visit_undef_node(*args, **, &blk); end
  def visit_unless_node(*args, **, &blk); end
  def visit_until_node(*args, **, &blk); end
  def visit_when_node(*args, **, &blk); end
  def visit_while_node(*args, **, &blk); end
  def visit_x_string_node(*args, **, &blk); end
  def visit_yield_node(*args, **, &blk); end
  extend T::Private::Methods::MethodHooks
  extend T::Private::Methods::SingletonMethodHooks
  extend T::Sig
end
...
class Spoom::Deadcode::Location
  ...
  def initialize(*args, **, &blk); end
  def self.from_prism(*args, **, &blk); end
...
class Spoom::Deadcode::Remover::NodeContext
  def attached_comments(*args, **, &blk); end
  def attached_sig(*args, **, &blk); end
  def attached_sigs(*args, **, &blk); end
  def comments(*args, **, &blk); end
  def comments_between_lines(*args, **, &blk); end
  def initialize(*args, **, &blk); end
