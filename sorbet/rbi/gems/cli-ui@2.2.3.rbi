...
module CLI::UI
  class << self
    ...
    #
    # source://cli-ui//lib/cli/ui.rb#99
    ...
    #
    # source://cli-ui//lib/cli/ui.rb#117
    sig do
      params(
        question: ::String,
    ...
    #
    # source://cli-ui//lib/cli/ui.rb#348
    ...
    #
    # source://cli-ui//lib/cli/ui.rb#172
    ...
    #
    # source://cli-ui//lib/cli/ui.rb#237
    sig do
      type_parameters(:T)
        .params(
          text: ::String,
    ...
    #
    # source://cli-ui//lib/cli/ui.rb#362
    ...
    #
    # source://cli-ui//lib/cli/ui.rb#368
    ...
    #
    # source://cli-ui//lib/cli/ui.rb#299
    sig do
      type_parameters(:T)
        .params(
          path: ::String,
    ...
    #
    # source://cli-ui//lib/cli/ui.rb#199
    sig do
      params(
        msg: ::String,
    ...
    #
    # source://cli-ui//lib/cli/ui.rb#324
    ...
    #
    # source://cli-ui//lib/cli/ui.rb#150
    ...
    #
    # source://cli-ui//lib/cli/ui.rb#268
    sig do
      params(
        title: ::String,
    ...
    #
    # source://cli-ui//lib/cli/ui.rb#284
    sig do
      type_parameters(:T)
        .params(
    ...
    # source://cli-ui//lib/cli/ui.rb#177
...
module CLI::UI::ANSI
  class << self
    # source://cli-ui//lib/cli/ui/ansi.rb#194
    sig { returns(::String) }
...
class CLI::UI::Formatter
  ...
  # source://cli-ui//lib/cli/ui/formatter.rb#210
...
module CLI::UI::Frame
  class << self
    ...
    #
    # source://cli-ui//lib/cli/ui/frame.rb#231
    sig do
      params(
    ...
    # @raise [UnnestedFrameException]
    #
    # source://cli-ui//lib/cli/ui/frame.rb#181
    sig do
      params(
        text: T.nilable(::String),
        color: T.nilable(T.any(::CLI::UI::Color, ::String, ::Symbol)),
    ...
    #   ┏━━ Open ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
    #
    # source://cli-ui//lib/cli/ui/frame.rb#91
    sig do
      type_parameters(:T)
        .params(
          text: ::String,
    ...
    #
    # source://cli-ui//lib/cli/ui/frame.rb#291
    sig do
      type_parameters(:T)
        .params(
          color: T.any(::CLI::UI::Color, ::String, ::Symbol),
    ...
    #
    # source://cli-ui//lib/cli/ui/frame.rb#306
...
module CLI::UI::Frame::FrameStack
  class << self
    ...
    #
    # source://cli-ui//lib/cli/ui/frame/frame_stack.rb#61
    sig do
      params(
...
class CLI::UI::Frame::FrameStack::StackItem
  # source://cli-ui//lib/cli/ui/frame/frame_stack.rb#20
  sig do
    params(
  ...
  # source://cli-ui//lib/cli/ui/frame/frame_stack.rb#11
...
module CLI::UI::Prompt
  class << self
    ...
    #
    # source://cli-ui//lib/cli/ui/prompt.rb#226
    sig { params(prompt: ::String).returns(T.nilable(::String)) }
    def any_key(prompt = T.unsafe(nil)); end
    ...
    #   end
    #
    # source://cli-ui//lib/cli/ui/prompt.rb#128
    sig do
      params(
        question: ::String,
        options: T.nilable(T::Array[::String]),
    ...
    #
    # source://cli-ui//lib/cli/ui/prompt.rb#183
    ...
    #
    # source://cli-ui//lib/cli/ui/prompt.rb#214
    sig { params(question: ::String, default: T::Boolean).returns(T::Boolean) }
    def confirm(question, default: T.unsafe(nil)); end

    # source://cli-ui//lib/cli/ui/prompt.rb#33
    sig { returns(::CLI::UI::Color) }
    ...
    #
    # source://cli-ui//lib/cli/ui/prompt.rb#44
    ...
    #
    # source://cli-ui//lib/cli/ui/prompt.rb#235
    sig { returns(T.nilable(::String)) }
    def read_char; end

    private

    # source://cli-ui//lib/cli/ui/prompt.rb#254
    sig do
      params(
        question: ::String,
    ...
    # @raise [ArgumentError]
    #
    # source://cli-ui//lib/cli/ui/prompt.rb#292
    sig do
      params(
        question: ::String,
        options: T.nilable(T::Array[::String]),
    ...
    #
    # source://cli-ui//lib/cli/ui/prompt.rb#351
    sig do
      params(
    ...
    # source://cli-ui//lib/cli/ui/prompt.rb#371
    sig { params(str: ::String).void }
    def puts_question(str); end

    # source://cli-ui//lib/cli/ui/prompt.rb#376
    sig { params(is_file: T::Boolean).returns(::String) }
    def readline(is_file: T.unsafe(nil)); end

    # source://cli-ui//lib/cli/ui/prompt.rb#358
...
class CLI::UI::Prompt::InteractiveOptions
  ...
  # source://cli-ui//lib/cli/ui/prompt/interactive_options.rb#250
  ...
  # source://cli-ui//lib/cli/ui/prompt/interactive_options.rb#256
  sig { void }
  def chop_selection; end

  # source://cli-ui//lib/cli/ui/prompt/interactive_options.rb#150
  ...
  #
  # source://cli-ui//lib/cli/ui/prompt/interactive_options.rb#166
  sig { returns(T::Boolean) }
  def display_metadata?; end

  # source://cli-ui//lib/cli/ui/prompt/interactive_options.rb#437
  sig { returns(::Integer) }
  def distance_from_selection_to_end; end

  # source://cli-ui//lib/cli/ui/prompt/interactive_options.rb#442
  sig { returns(::Integer) }
  def distance_from_start_to_selection; end

  # source://cli-ui//lib/cli/ui/prompt/interactive_options.rb#206
  sig { void }
  def down; end

  # source://cli-ui//lib/cli/ui/prompt/interactive_options.rb#457
  sig { void }
  def ensure_first_item_is_continuation_marker; end

  # source://cli-ui//lib/cli/ui/prompt/interactive_options.rb#452
  sig { void }
  def ensure_last_item_is_continuation_marker; end

  # source://cli-ui//lib/cli/ui/prompt/interactive_options.rb#430
  sig { void }
  def ensure_visible_is_active; end

  # source://cli-ui//lib/cli/ui/prompt/interactive_options.rb#357
  sig { returns(T::Boolean) }
  def filtering?; end

  # source://cli-ui//lib/cli/ui/prompt/interactive_options.rb#518
  sig { params(format: ::String, choice: ::String).returns(::String) }
  def format_choice(format, choice); end

  # source://cli-ui//lib/cli/ui/prompt/interactive_options.rb#362
  sig { returns(T::Boolean) }
  def has_filter?; end

  # source://cli-ui//lib/cli/ui/prompt/interactive_options.rb#447
  sig { returns(::Integer) }
  def index_of_active_option; end

  # source://cli-ui//lib/cli/ui/prompt/interactive_options.rb#462
  sig { returns(::Integer) }
  def max_lines; end

  # source://cli-ui//lib/cli/ui/prompt/interactive_options.rb#171
  sig { returns(::Integer) }
  def num_lines; end

  # source://cli-ui//lib/cli/ui/prompt/interactive_options.rb#387
  ...
  # source://cli-ui//lib/cli/ui/prompt/interactive_options.rb#467
  sig { void }
  def render_options; end

  # source://cli-ui//lib/cli/ui/prompt/interactive_options.rb#141
  sig { params(number_of_lines: ::Integer).void }
  def reset_position(number_of_lines = T.unsafe(nil)); end

  # source://cli-ui//lib/cli/ui/prompt/interactive_options.rb#240
  sig { params(char: ::String).void }
  ...
  #
  # source://cli-ui//lib/cli/ui/prompt/interactive_options.rb#219
  sig { params(n: ::Integer).void }
  def select_n(n); end

  # source://cli-ui//lib/cli/ui/prompt/interactive_options.rb#352
  sig { returns(T::Boolean) }
  def selecting?; end

  # source://cli-ui//lib/cli/ui/prompt/interactive_options.rb#367
  sig { void }
  def start_filter; end

  # source://cli-ui//lib/cli/ui/prompt/interactive_options.rb#373
  sig { void }
  def start_line_select; end

  # source://cli-ui//lib/cli/ui/prompt/interactive_options.rb#380
  sig { void }
  ...
  # source://cli-ui//lib/cli/ui/prompt/interactive_options.rb#195
  sig { void }
  def up; end

  # source://cli-ui//lib/cli/ui/prompt/interactive_options.rb#262
  sig { params(char: ::String).void }
  def update_search(char); end

  # source://cli-ui//lib/cli/ui/prompt/interactive_options.rb#295
  sig { void }
...
# source://cli-ui//lib/cli/ui/prompt/interactive_options.rb#189
...
class CLI::UI::Spinner::SpinGroup
  ...
  #   spin_group.wait
  #
  # source://cli-ui//lib/cli/ui/spinner/spin_group.rb#260
  sig do
    params(
      title: ::String,
  ...
  # source://cli-ui//lib/cli/ui/spinner/spin_group.rb#357
  sig { returns(T::Boolean) }
  def all_succeeded?; end

  # Debriefs failed tasks is +auto_debrief+ is true
  #
  # source://cli-ui//lib/cli/ui/spinner/spin_group.rb#366
  sig { returns(T::Boolean) }
  def debrief; end

  # Provide an alternative debriefing for failed tasks
  #
  # source://cli-ui//lib/cli/ui/spinner/spin_group.rb#342
  sig do
    params(
  ...
  #
  # source://cli-ui//lib/cli/ui/spinner/spin_group.rb#352
  ...
  class << self
    # source://cli-ui//lib/cli/ui/spinner/spin_group.rb#13
    sig { returns(::Thread::Mutex) }
    def pause_mutex; end

    # source://cli-ui//lib/cli/ui/spinner/spin_group.rb#25
    sig { type_parameters(:T).params(block: T.proc.returns(T.type_parameter(:T))).returns(T.type_parameter(:T)) }
...
# source://cli-ui//lib/cli/ui/spinner/spin_group.rb#7
CLI::UI::Spinner::SpinGroup::DEFAULT_FINAL_GLYPH = T.let(T.unsafe(nil), Proc)

# source://cli-ui//lib/cli/ui/spinner/spin_group.rb#75
class CLI::UI::Spinner::SpinGroup::Task
  ...
  def initialize(title, final_glyph:, merged_output:, duplicate_output_to:, &block); end
  ...
  # source://cli-ui//lib/cli/ui/spinner/spin_group.rb#85
  ...
  #
  # source://cli-ui//lib/cli/ui/spinner/spin_group.rb#166
  ...
  # source://cli-ui//lib/cli/ui/spinner/spin_group.rb#82
  sig { returns(T::Boolean) }
  def success; end
  ...
  #
  # source://cli-ui//lib/cli/ui/spinner/spin_group.rb#185
  sig { params(new_title: ::String).void }
  def update_title(new_title); end

  private

  # source://cli-ui//lib/cli/ui/spinner/spin_group.rb#201
  ...
  # source://cli-ui//lib/cli/ui/spinner/spin_group.rb#229
  sig { returns(::String) }
  def inset; end

  # source://cli-ui//lib/cli/ui/spinner/spin_group.rb#234
  sig { returns(::Integer) }
  def inset_width; end

  # source://cli-ui//lib/cli/ui/spinner/spin_group.rb#215
  sig { params(index: ::Integer).returns(::String) }
...
module CLI::UI::StdoutRouter
  class << self
    # @raise [NotEnabled]
    #
    # source://cli-ui//lib/cli/ui/stdout_router.rb#350
    sig { void }
    def assert_enabled!; end

    # source://cli-ui//lib/cli/ui/stdout_router.rb#345
    sig { returns(T.nilable(T::Hash[::Symbol, T.any(::IO, ::String, ::StringIO)])) }
    def current_id; end

    # source://cli-ui//lib/cli/ui/stdout_router.rb#383
    sig { returns(T::Boolean) }
    def disable; end

    # source://cli-ui//lib/cli/ui/stdout_router.rb#325
    ...
    # source://cli-ui//lib/cli/ui/stdout_router.rb#369
    sig { returns(T::Boolean) }
    def enable; end
    ...
    # TODO: remove this
    #
    # source://cli-ui//lib/cli/ui/stdout_router.rb#364
    sig { void }
    def ensure_activated; end

    # source://cli-ui//lib/cli/ui/stdout_router.rb#355
    sig { type_parameters(:T).params(block: T.proc.returns(T.type_parameter(:T))).returns(T.type_parameter(:T)) }
    def with_enabled(&block); end

    # source://cli-ui//lib/cli/ui/stdout_router.rb#332
    sig do
      type_parameters(:T)
        .params(
...
class CLI::UI::StdoutRouter::Capture
  ...
  # source://cli-ui//lib/cli/ui/stdout_router.rb#213
  ...
  # source://cli-ui//lib/cli/ui/stdout_router.rb#251
  sig { returns(::String) }
  def stdout; end

  class << self
    # source://cli-ui//lib/cli/ui/stdout_router.rb#104
    sig { returns(T.nilable(::CLI::UI::StdoutRouter::Capture)) }
    def current_capture; end

    # source://cli-ui//lib/cli/ui/stdout_router.rb#109
    sig { returns(::CLI::UI::StdoutRouter::Capture) }
    def current_capture!; end

    # source://cli-ui//lib/cli/ui/stdout_router.rb#114
    sig { type_parameters(:T).params(block: T.proc.returns(T.type_parameter(:T))).returns(T.type_parameter(:T)) }
    def in_alternate_screen(&block); end

    # source://cli-ui//lib/cli/ui/stdout_router.rb#141
    sig { type_parameters(:T).params(block: T.proc.returns(T.type_parameter(:T))).returns(T.type_parameter(:T)) }
    def stdin_synchronize(&block); end

    # source://cli-ui//lib/cli/ui/stdout_router.rb#155
    sig { type_parameters(:T).params(block: T.proc.returns(T.type_parameter(:T))).returns(T.type_parameter(:T)) }
    def with_stdin_masked(&block); end

    private

    # source://cli-ui//lib/cli/ui/stdout_router.rb#181
    sig { returns(T::Boolean) }
    def outermost_uncaptured?; end
  end
end

# source://cli-ui//lib/cli/ui/stdout_router.rb#260
class CLI::UI::StdoutRouter::Capture::BlockingInput
  # source://cli-ui//lib/cli/ui/stdout_router.rb#264
  sig { params(stream: ::IO).void }
  def initialize(stream); end

  # source://cli-ui//lib/cli/ui/stdout_router.rb#310
  ...
  # source://cli-ui//lib/cli/ui/stdout_router.rb#302
  ...
  # source://cli-ui//lib/cli/ui/stdout_router.rb#310
  def nonblock(*args, **kwargs, &block); end
  ...
  # source://cli-ui//lib/cli/ui/stdout_router.rb#270
  sig { type_parameters(:T).params(block: T.proc.returns(T.type_parameter(:T))).returns(T.type_parameter(:T)) }
...
# source://cli-ui//lib/cli/ui/stdout_router.rb#299
CLI::UI::StdoutRouter::Capture::BlockingInput::NON_READING_METHODS = T.let(T.unsafe(nil), Array)

# source://cli-ui//lib/cli/ui/stdout_router.rb#280
